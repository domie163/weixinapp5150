    ...
    <view class="content">
        <form class="app-update-pv">
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">教练名称</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.jiaolianName" type="text" v-model="ruleForm.jiaolianName" placeholder="教练名称"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">教练手机号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.jiaolianPhone" type="text" v-model="ruleForm.jiaolianPhone" placeholder="教练手机号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">教练身份证号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.jiaolianIdNumber" type="text" v-model="ruleForm.jiaolianIdNumber" placeholder="教练身份证号"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="jiaolianPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">教练头像</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.jiaolianPhoto" :src="baseUrl+ruleForm.jiaolianPhoto" mode="aspectFill">
                        </image>
                ...
                <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">教练类型</view>
                    <picker @change="jiaolianTypesChange" :value="jiaolianTypesIndex" :range="jiaolianTypesOptions" range-key="indexName">
                        <view
                                :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.jiaolianTypes?ruleForm.jiaolianValue:"请选择教练类型"}}</view>
                    </picker>
                </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">教练邮箱</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.jiaolianEmail" type="text" v-model="ruleForm.jiaolianEmail" placeholder="教练邮箱"></input>
            </view>
...
<script>
    ...
    export default {
		...
		/*下拉框*/
			let jiaolianTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'jiaolian_types',
            }
			let jiaolianTypes = await this.$api.page(`dictionary`, jiaolianTypesParams);
			this.jiaolianTypesOptions = jiaolianTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`jiaolian`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.jiaolianId){
                this.ruleForm.jiaolianId = options.jiaolianId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.jiaolianName)) {
                    this.$utils.msg(`教练名称不能为空`);
                    return
                }
				if ((!this.ruleForm.jiaolianPhone) && (!this.$validate.isMobile(this.ruleForm.jiaolianPhone))) {
                    this.$utils.msg(`教练手机号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.jiaolianIdNumber) && (!this.$validate.checkIdCard(this.ruleForm.jiaolianIdNumber))) {
                    this.$utils.msg(`教练身份证号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.jiaolianPhoto)) {
                    this.$utils.msg(`教练头像不能为空`);
                    return
                }
				...
				if ((!this.ruleForm.jiaolianEmail) && (!this.$validate.isEmail(this.ruleForm.jiaolianEmail))) {
                    this.$utils.msg(`教练邮箱不能为空并且需要输入正确格式`);
                    return
                }
                if (this.ruleForm.id) {
                    await this.$api.update(`jiaolian`, this.ruleForm);
                } else {
                    await this.$api.save(`jiaolian`, this.ruleForm);
                }
