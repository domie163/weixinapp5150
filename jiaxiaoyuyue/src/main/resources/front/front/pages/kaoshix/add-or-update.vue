        ...
        <form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.kaoshixName" type="text" v-model="ruleForm.kaoshixName" placeholder="通知标题"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="kaoshixPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">通知封面</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.kaoshixPhoto" :src="baseUrl+ruleForm.kaoshixPhoto" mode="aspectFill">
                        </image>
                      ...
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">考试类型</view>
                    <picker @change="kaoshixTypesChange" :value="kaoshixTypesIndex" :range="kaoshixTypesOptions" range-key="indexName">
                        <view
                                :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.kaoshixTypes?ruleForm.kaoshixValue:"请选择考试类型"}}</view>
                    </picker>
                </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">考试地址</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.kaoshixAddress" type="text" v-model="ruleForm.kaoshixAddress" placeholder="考试地址"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">考试时间</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.kaoshixShijian" type="text" v-model="ruleForm.kaoshixShijian" placeholder="考试时间"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">截止时间</view>
                <input
                        :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                        v-model="ruleForm.kaoshixTime" placeholder="截止时间" :readonly="ro.kaoshixTime"
                        @tap="toggleTab('kaoshixTime')"></input>
            </view>
					<!-- text后缀 -->
            <view
                ...
                <textarea :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.kaoshixContent" v-model="ruleForm.kaoshixContent" placeholder="详情信息"/>
            </view>
            ...
            <view class="btn">
                <button
					...
					<w-picker mode="dateTime" step="1" :current="false" :hasSecond="false" @confirm="kaoshixTimeConfirm"
                              ref="kaoshixTime" themeColor="#333333"></w-picker>
...
<script>
    ...
    export default {
		...
		/*下拉框*/
			let kaoshixTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'kaoshix_types',
            }
			let kaoshixTypes = await this.$api.page(`dictionary`, kaoshixTypesParams);
			this.kaoshixTypesOptions = kaoshixTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`kaoshix`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.kaoshixId){
                this.ruleForm.kaoshixId = options.kaoshixId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.kaoshixName)) {
                    this.$utils.msg(`通知标题不能为空`);
                    return
                }
				if ((!this.ruleForm.kaoshixPhoto)) {
                    this.$utils.msg(`通知封面不能为空`);
                    return
                }
				if ((!this.ruleForm.kaoshixAddress)) {
                    this.$utils.msg(`考试地址不能为空`);
                    return
                }
				if ((!this.ruleForm.kaoshixShijian)) {
                    this.$utils.msg(`考试时间不能为空`);
                    return
                }
				if ((!this.ruleForm.kaoshixTime)) {
                    this.$utils.msg(`截止时间不能为空`);
                    return
                }
                if (this.ruleForm.id) {
                    await this.$api.update(`kaoshix`, this.ruleForm);
                } else {
                    await this.$api.save(`kaoshix`, this.ruleForm);
                }
