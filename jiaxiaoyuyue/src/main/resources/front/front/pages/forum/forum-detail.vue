	...
	<view>
        ...
        <view class="username">
			<text v-if="forum.yonghuId != null">
				 发布人：{{forum.yonghuName}}（学员）
			</text>
			<text v-if="forum.jiaolianId != null">
				 发布人：{{forum.jiaolianName}}（教练）
			</text>
			...
			<view class="uni-article__comment-box" v-for="comment in commentData" :key="comment.id" >
				<view class="article-meta">
					<view class="article-header-image">
                        ...
                        <image v-if="comment.jiaolianId != null" class="image" :src="baseUrl+comment.jiaolianPhoto" mode="widthFix"></image>
					...
					<view class="article-header-content">
						<view class="article-header-title">
							...
							<text v-if="comment.jiaolianId != null">{{comment.jiaolianName}}</text>
