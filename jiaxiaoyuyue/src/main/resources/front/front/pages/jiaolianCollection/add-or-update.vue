        ...
        <form class="app-update-pv">
                <!--<view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    ...
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">教练</view>
                    <picker @change="jiaolianChange" :value="jiaolianIndex" :range="jiaolianOptions" range-key="jiaolianName">
                        <view
                                ...
                                class="uni-input">{{ruleForm.jiaolianId?ruleForm.jiaolianName:"请选择教练"}}</view>
                    </picker>
                </view>-->
                <!--<view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                      class="cu-form-group">
                    ...
                    <picker @change="yonghuChange" :value="yonghuIndex" :range="yonghuOptions" range-key="yonghuName">
                        <view
                                :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.yonghuId?ruleForm.yonghuName:"请选择学员"}}</view>
                    </picker>
                </view>-->
                <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">类型</view>
                    <picker @change="jiaolianCollectionTypesChange" :value="jiaolianCollectionTypesIndex" :range="jiaolianCollectionTypesOptions" range-key="indexName">
                        <view
                                ...
                                class="uni-input">{{ruleForm.jiaolianCollectionTypes?ruleForm.jiaolianCollectionValue:"请选择类型"}}</view>
                    </picker>
                </view>
...
<script>
    ...
    export default {
		...
		/*下拉框*/
			let jiaolianCollectionTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'jiaolian_collection_types',
            }
			let jiaolianCollectionTypes = await this.$api.page(`dictionary`, jiaolianCollectionTypesParams);
			this.jiaolianCollectionTypesOptions = jiaolianCollectionTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`jiaolianCollection`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.jiaolianCollectionId){
                this.ruleForm.jiaolianCollectionId = options.jiaolianCollectionId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            // 下拉变化
            jiaolianCollectionTypesChange(e) {
            ...
            async onSubmitTap() {
                if (this.ruleForm.id) {
                    await this.$api.update(`jiaolianCollection`, this.ruleForm);
                } else {
                    await this.$api.save(`jiaolianCollection`, this.ruleForm);
                }
